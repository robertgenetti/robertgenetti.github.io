...
<div class="container">
    <div class="row justify-content-between">
        <div class="col-12 col-md-6 mb-5">
            ...
            <p>In this project we explored public pension fund data in an effort to gain a better understanding of how specific factors contribute to low levels of unfunded liabilities. The results, low total deductions relative to cash inflows significantly contributed to greater positive impacts of investment gains and decreased the burden on state and local government to make up the difference for cash outflows. Investment gains, even in extraordinaty times such as experienced in 2021, are not enough to correct for years of cashflow imbalances. Policy recommendation moving forward is to focus on improvements to monitoring and evaluating cashflows, making adjustment as needed.</p>
